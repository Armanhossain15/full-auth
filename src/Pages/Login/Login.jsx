...
const Login = () => {
    ...
    const { signInUser, creatUserByGoogle } = useContext(authContext)
                ...
                <div className="w-[90%] lg:w-2/5 mx-auto shadow-xl border  card-body">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="form-control mt-2">
                            <button className="btn bg-green-700 hover:bg-green-800 text-white rounded-none text-base">Login</button>
                        </div>

                        <p className="mt-3">Alreay have an account ? <Link to='/register' className="font-bold underline ">Sign Up</Link></p>
                    </form>
